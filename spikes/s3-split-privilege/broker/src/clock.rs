...
//!
//! `docs/18-LOGGING.md` stores `created_utc` and friends as TEXT, and the spike
//! keeps that shape so the job rows are readable in the transcript. Pulling in
//! a calendar dependency for a throwaway crate is not worth it, and the civil
//! calendar conversion is twenty lines.
...
mod tests {
    ...
    fn a_leap_day_is_not_off_by_one() {
        ...
        assert_eq!(from_unix_millis(1_709_164_800_000), "2024-02-29T00:00:00.000Z");
    }
}
